export default {
	...
	haruna: async function (m, { sock, api, text }) {
		...
		try {
			if (action === "search") {
				const res = await api.get("/api/shinigami/search", { q: queryText });
				...
				const res = await api.get("/api/shinigami/detail", { url: queryText });
				...
				const res = await api.get("/api/shinigami/lastupdate");
