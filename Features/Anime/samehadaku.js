export default {
	...
	haruna: async function (m, { sock, api, text }) {
		...
		try {
			if (action === "search") {
				const res = await api.get("/samehadaku/search", { q: queryText });
				...
				const res = await api.get("/samehadaku/detail", { url: queryText });
				...
				const res = await api.get("/samehadaku/download", { url: queryText });
				...
				const res = await api.get("/samehadaku/lastupdate");
