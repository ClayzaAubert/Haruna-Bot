    ...
    haruna: async function (m, { sock, api, text }) {
        try {
            ...
            if (text.startsWith("generate")) {
                ...
                const modelRes = await api.get("/prodia/model");
                ...
                const generateRes = await api.get("/prodia/generate", { prompt: promptText, model: selectedModel });
                ...
                const clayza = generateRes.result;

                await sock.sendMessage(
                    m.chat,
                    {
                        image: { url: clayza.url },
