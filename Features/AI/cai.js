        ...
        try {
            ...
            if (text.startsWith("search")) {
                ...
                m.replyUpdate("Searching...", async (update) => {
                    const res = await api.get("/api/cai/search", { q: searchTerm });
            ...
            // Create Room command
                ...
                m.replyUpdate("Creating room...", async (update) => {
                    const res = await api.get("/api/cai/createroom", { charid: charId });
            ...
            // Chat command
                ...
                m.replyUpdate("Chatting...", async (update) => {
                    const res = await api.get("/api/cai/chat", { q: text, charid: "cQaMyajxdi6r5_403nN_5x_MgC4hk1ud3gE5LocrBHw", chatid: "ff07f3f4-fc58-4b98-971c-898164476ca3" });
