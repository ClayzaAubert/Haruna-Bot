...
export function xpRange(level, multiplier = Config.multiplier || 1) {
...
export function findLevel(xp, multiplier = Config.multiplier || 1) {
...
export function canLevelUp(level, xp, multiplier = Config.multiplier || 1) {
